...
- **指摘がない場合**：`references/commit.md` の方針に従って、どうコミット・整理し、この後どう PR を作成・更新するのが良いか（未マージのコミットの整え方、コミットメッセージと PR のタイトル・本文の言語、テストケースを追加した場合に PR 本文へ列挙する追加テストケースの一覧、既存 PR を更新する場合の一覧の追従を含む）を伝える。
